//
//  SpotifyPlaylistTableViewController.swift
//  MusicFav
//
...
class SpotifyPlaylistTableViewController: UITableViewController {
    let tableCellReuseIdentifier = "playlistTableViewCell"
    let cellHeight: CGFloat      = 80

    var indicator:      UIActivityIndicatorView!

    var playlistRepository: SpotifyPlaylistRepository!
    ...
    func updateNavbar() {
        let showFavListButton = UIBarButtonItem(image: UIImage(named: "fav_list"),
                                                ...
                                                target: self,
                                                action: #selector(SpotifyPlaylistTableViewController.showFavoritePlaylist))
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .playlists:
            ...
            cell.trackNumLabel.text = playlist.owner.displayName
            if let url = playlist.smallestImage?.imageURL {
                cell.thumbImageView.sd_setImage(with: url, placeholderImage: UIImage(named: "spotify"))
            } else {
